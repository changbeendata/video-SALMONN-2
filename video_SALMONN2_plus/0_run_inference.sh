...
CUDA_VISIBLE_DEVICES=5 bash scripts/test.sh --interval 0.1 --run_name eval --dataset /data1/changbeenkim/video-SALMONN-2/video_SALMONN2_plus/scripts/example_video_mme_av.json --max_frames 768 --max_pixels 61250 --model /data1/changbeenkim/video-SALMONN-2/models/video_SALMONN2plus_7B_audioAlign --model_base /data1/changbeenkim/video-SALMONN-2/models/video_SALMONN2plus_7B_audioAlign --lora_ckpt /data1/changbeenkim/video-SALMONN-2/models/video-SALMONN-2_plus_7B